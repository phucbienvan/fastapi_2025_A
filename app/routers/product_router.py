...
from app.middleware.authenticate import authenticate_required

router = APIRouter(prefix='/products', dependencies=[Depends(authenticate_required)])


@router.get("", tags=["products"], description="Get all products", response_model=DataResponse[list[ProductSchema]])
...
@router.post("", tags=["products"], description="Create a new product", response_model=DataResponse[ProductSchema])
...
@router.get("/{product_id}", tags=["products"], description="Get a product by id", response_model=DataResponse[ProductSchema])
...
@router.delete("/{product_id}", tags=["products"], description="Delete a product by id", response_model=DataResponse[ProductSchema])
...
@router.put("/{product_id}", tags=["products"], description="Update a product by id", response_model=DataResponse[ProductSchema])
